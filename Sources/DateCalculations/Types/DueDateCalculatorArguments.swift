...
public struct DueDateCalculatorArguments: Sendable, Codable {
    public var type: DateComponent
    public var json: String?
    public var dateComponentInterval: DateComponentInterval?
    public let everyExternal: Int?
    public var timePeriodsCheck: (@Sendable (_ date: Date) -> Date)?
    
    public init(type: DateComponent = .year, json: String? = nil, dateComponentInterval: DateComponentInterval? = nil, everyExternal: Int? = nil, timePeriodsCheck: (@Sendable (_ date: Date) -> Date)? = nil) {
        self.type = type
        self.json = json
